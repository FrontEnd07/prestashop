...
class __TwigTemplate_a77ff6c01aed61928bd42d0316eedcf0850b2356a16ac4bba508c2af52b24040 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        foreach ($context['_seq'] as $context["name"] => $context["value"]) {
            // line 32
            echo "  ";
            if ((0 === twig_compare($context["value"], ($context["selectedChoice"] ?? null)))) {
                // line 33
                echo "    ";
...
";
    ...
    >
      ";
            // line 60
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_array_filter($this->env, ($context["choices"] ?? null), function ($__value__) use ($context, $macros) { $context["value"] = $__value__; return (0 !== twig_compare($context["value"], ($context["selectedChoice"] ?? null))); }));
            foreach ($context['_seq'] as $context["name"] => $context["value"]) {
                // line 61
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Common/Grid/Columns/Content/choice.html.twig", "C:\\xampp\\htdocs\\prestashopDemo\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Common\\Grid\\Columns\\Content\\choice.html.twig");
    }
}
