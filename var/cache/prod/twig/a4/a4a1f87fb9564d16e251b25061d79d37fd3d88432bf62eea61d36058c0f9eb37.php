...
class __TwigTemplate_ccfa3a3d2416f602977834f559d6ec080de1e4c0ba920e2272402d110ccebd42 extends Template
{
    private $source;
    private $macros = [];
        ...
        <div class=\"row\">
          <div class=\"col\">
            <h3 class=\"card-header-title\">
              ";
        // line 33
        if (( !(null === twig_get_attribute($this->env, $this->source, ($context["orderForViewing"] ?? null), "customer", [], "any", false, false, false, 33)) && (0 !== twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["orderForViewing"] ?? null), "customer", [], "any", false, false, false, 33), "id", [], "any", false, false, false, 33), 0)))) {
            // line 34
            echo "                ";
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Sell/Order/Order/Blocks/View/Modal/view_all_messages_modal.html.twig", "C:\\xampp\\htdocs\\prestashopDemo\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Sell\\Order\\Order\\Blocks\\View\\Modal\\view_all_messages_modal.html.twig");
    }
}
