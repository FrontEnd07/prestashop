...
class __TwigTemplate_2935e1a5bad2f99659de5b0ab20eb2965cb9de4cb148b793858ab27bce4ffbe7 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"title-content\">
  ...
  <p class=\"lead d-inline\">
    ...
    ";
        // line 35
        if (( !(null === twig_get_attribute($this->env, $this->source, ($context["orderForViewing"] ?? null), "customer", [], "any", false, false, false, 35)) && (0 !== twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["orderForViewing"] ?? null), "customer", [], "any", false, false, false, 35), "id", [], "any", false, false, false, 35), 0)))) {
            // line 36
            echo "      ";
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Sell/Order/Order/Blocks/View/header.html.twig", "C:\\xampp\\htdocs\\prestashopDemo\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Sell\\Order\\Order\\Blocks\\View\\header.html.twig");
    }
}
