...
class __TwigTemplate_0b5ac4b5895d9fd14bf7b26adee5d53cdf6e3e67ca6b0e0378aa194b9e0e4b7e extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
            ...
            // line 32
            echo "  ";
            if ((1 === twig_compare(twig_get_attribute($this->env, $this->source, $context["product"], "quantityRefunded", [], "any", false, false, false, 32), 0))) {
                // line 33
                echo "    ";
    ...
    ";
      ...
      <div class=\"col-xl-6 d-print-none order-product-pagination\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["numPageOption"]) {
            ...
            echo "\" ";
            if ((0 === twig_compare($context["numPageOption"], ($context["paginationNum"] ?? null)))) {
                echo " selected ";
            }
            echo ">";
            echo twig_escape_filter($this->env, $context["numPageOption"], "html", null, true);
        ...
        if ((0 >= twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["orderForViewing"] ?? null), "products", [], "any", false, false, false, 124), "products", [], "any", false, false, false, 124)), ($context["paginationNum"] ?? null)))) {
            echo " class=\"d-none\"";
        }
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["numPage"]) {
            ...
            if ((0 === twig_compare($context["numPage"], 1))) {
                echo " active";
            }
            echo "\">
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Sell/Order/Order/Blocks/View/products.html.twig", "C:\\xampp\\htdocs\\prestashopDemo\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Sell\\Order\\Order\\Blocks\\View\\products.html.twig");
    }
}
