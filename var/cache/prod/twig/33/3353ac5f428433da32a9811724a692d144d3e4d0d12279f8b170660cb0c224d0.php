...
class __TwigTemplate_533f1261d991d64ccd30ffe98f28e2df0df023742b5e01b1c9ed0674512dee57 extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 26
        $context["rowIsDisplayed"] = ((array_key_exists("productIndex", $context) && array_key_exists("paginationNum", $context)) && (1 === twig_compare(($context["productIndex"] ?? null), ($context["paginationNum"] ?? null))));
        // line 27
  ...
  <td class=\"cellProductName\">
    ...
    ";
        // line 49
        if (((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "type", [], "any", false, false, false, 49), twig_constant("PrestaShop\\PrestaShop\\Core\\Domain\\Order\\QueryResult\\OrderProductForViewing::TYPE_PACK"))) && (null === twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "customizations", [], "any", false, false, false, 49)))) {
            // line 50
  ...
  <td class=\"cellProductQuantity text-center\">
    ";
        // line 57
        if ((1 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "quantity", [], "any", false, false, false, 57), 1))) {
            // line 58
  ...
  <td class=\"cellProductRefunded";
    ...
    ";
        // line 69
        if ((1 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "quantityRefunded", [], "any", false, false, false, 69), 0))) {
            // line 70
            echo "      ";
  ...
  ";
    ...
    <div class=\"cancel-product-cell cancel-product-element";
        // line 114
        if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "refundable", [], "any", false, false, false, 114), false))) {
            echo " hidden";
        }
        echo "\">
...
";
    ...
    ";
      ...
      ";
            ...
            // line 174
            echo "      ";
            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "type", [], "any", false, false, false, 174), twig_constant("PrestaShop\\PrestaShop\\Core\\Domain\\Order\\QueryResult\\OrderProductForViewing::TYPE_PACK")))) {
                // line 175
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Sell/Order/Order/Blocks/View/product.html.twig", "C:\\xampp\\htdocs\\prestashopDemo\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Sell\\Order\\Order\\Blocks\\View\\product.html.twig");
    }
}
