...
class __TwigTemplate_9c1377dd86b9f0a38be8e103ae0d75019010baf236e527e99c1a9fceaf7114da extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 27
        if ((0 !== twig_compare(twig_get_attribute($this->env, $this->source, ($context["backOfficeOrderButtons"] ?? null), "isEmpty", [], "method", false, false, false, 27), true))) {
            // line 28
            echo "
  ";
            // line 29
            ...
            // line 30
            echo "  ";
            if ((1 === twig_compare(twig_length_filter($this->env, ($context["buttons"] ?? null)), 2))) {
                // line 31
                echo "
    ";
                // line 32
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Sell/Order/Order/Blocks/View/extra_order_button_actions.html.twig", "C:\\xampp\\htdocs\\prestashopDemo\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Sell\\Order\\Order\\Blocks\\View\\extra_order_button_actions.html.twig");
    }
}
