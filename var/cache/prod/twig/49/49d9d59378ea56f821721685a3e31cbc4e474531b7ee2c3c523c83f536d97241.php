...
class __TwigTemplate_25b07115390d39b0f4f56eda5bc2a75f63722c53b8071d7f5b11af6eb7e7e89b extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <div class=\"d-print-none\">
      ";
        ...
        // line 41
        echo "      ";
        if ((0 !== twig_compare(($context["displayAdminOrderTopHookContent"] ?? null), ""))) {
            // line 42
            echo "        ";
    ...
    ";
        ...
        // line 94
        echo "    ";
        if (( !(null === twig_get_attribute($this->env, $this->source, ($context["orderForViewing"] ?? null), "customer", [], "any", false, false, false, 94)) && (0 !== twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["orderForViewing"] ?? null), "customer", [], "any", false, false, false, 94), "id", [], "any", false, false, false, 94), 0)))) {
            // line 95
            echo "      ";
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Sell/Order/Order/view.html.twig", "C:\\xampp\\htdocs\\prestashopDemo\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Sell\\Order\\Order\\view.html.twig");
    }
}
