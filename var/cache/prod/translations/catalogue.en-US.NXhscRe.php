...
Thanks for your patience.',
  ...
  array (
    ...
    'There was an error on module uninstall. Please contact us through Addons website' => 'There was an error on module uninstall. Please contact us through Addons website',
    'Data accessibility' => 'Data accessibility',
    'How can a customer retrieve all of his personal data?' => 'How can a customer retrieve all of his personal data?',
    'From his customer account, a new tab called My Personal Data is available and your customer can retrieve all of his personal data collected by your shop and installed modules, in PDF or CSV format.' => 'From his customer account, a new tab called My Personal Data is available and your customer can retrieve all of his personal data collected by your store and installed modules, in PDF or CSV format.',
    'Customer consent' => 'Customer consent',
    'There is no consent confirmation checkbox in the contact form. Isn\'t this a requirement?' => 'There is no consent confirmation checkbox in the contact form. Isn\'t this a requirement?',
    'No, it is not a requirement as the customer gives consent by clicking on the Submit message button. Only a message is required to give your customers more information about the use of personal data on your website. We are currently working on a new version of the contact form, it will be available really soon for your online store.' => 'No, it is not a requirement as the customer gives consent by clicking on the Submit message button. Only a message is required to give your customers more information about the use of personal data on your website. We are currently working on a new version of the contact form, it will be available really soon for your online store.',
    'Data erasure' => 'Data erasure',
    'How will a customer ask for all of his personal data to be deleted ?' => 'How will a customer ask for all of his personal data to be deleted?',
    'The customer will send a message from the contact form for any rectification and erasure requests, justifying his request.' => 'The customer will send a message from the contact form for any rectification and erasure requests, justifying his request.',
...
They can, however, contact you anytime via your contact form, in this case, you can review their request and once you accept it, you will be able to remove their personal data directly in the configuration page of our Official GDPR Compliance module.',
    'How to remove the personal data of a customer?' => 'How to remove the personal data of a customer?',
...
Before deleting any data, we recommend you to download all the invoices of the involved customer. After deleting the data with the “Remove data” button, the customer’s orders can’t be legally deleted, they just won’t be linked to any account. This allows you to keep precise statistics of your store.',
    'After removing all personal data of a customer from my database, what will happen to his orders?' => 'After removing all personal data of a customer from my database, what will happen to his orders?',
...
According to the Rec.30;Art.7(1)(c)' => 'Due to other legal obligations, his orders will still be stocked but they are no longer associated with the customer.
Only the name, shipping, and billing information must be kept in the order details page for legal reasons, invoicing, and accounting.
