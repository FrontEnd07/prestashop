...
class BinshopsrestBootstrapModuleFrontController extends AbstractRESTController
{
    ...
    protected function processGetRequest()
    {
        ...
        $psdata['newProducts'] = $newProducts['products'];
        $psdata['specialProducts'] = $specialProducts['products'];
        $psdata['lastComment'] = $lastComment['comments'];
    ...
    public function getLastComment()
    {
        ...
        $productComments = $productCommentRepository->getComment();
        ...
        foreach ($productComments as $productComment) {
            ...
            $productComment['image_manufacturer'] = $this->context->link->getManufacturerImageLink($productComment['id_manufacturer'], 'small_default');
