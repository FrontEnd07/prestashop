...
class BinshopsrestProductdetailModuleFrontController extends AbstractRESTController
{
    ...
    protected function processGetRequest()
    {
        ...
        if (!Validate::isLoadedObject($this->product)) {
            ...
            if ((bool)Tools::getValue('refresh', 0)) {
    ...
    public function getProduct()
    {
        ...
        $manufacturer_info[] = array(
            'id' => $this->product->id_manufacturer,
            'name' => $this->product->manufacturer_name,
            'image' => $this->context->link->getManufacturerImageLink($this->product->id_manufacturer, 'small_default'),
        );
